...
export default function Home() {
  ...
  const testimonials = [
    {
      ...
      title: "Direktur Utama PT Mayora Indah Tbk",
      text: "Jasa yang ditawarkan memang sesuai dengan keperluan Mayora sebagai Perusahaan yang memiliki banyak produk, kualitas yang ditawarkan sungguh luar biasa"
    },
    {
      name: "Tri Wahyuni",
      title: "Corporate Secretary PT Duta Pertiwi Nusantara Tbk",
      text: "Estetic menawarkan hal yang kami butuhkan dalam segi media relation dan pelayanan manajemen event"
    },
    {
      name: "Ariesman Widjaja",
      title: "Ex Direktur Utama PT Agung Podomoro Land Tbk",
      text: "Satu kata untuk Estetic, Lanjutkan!"
    }
  ];
  ...
  const services = {
    konsultansi: [
      "Public relations & strategi komunikasi",
      "Manajemen perusahaan & krisis isu",
  ...
  return (
    <div className="min-h-screen bg-[#082846] text-white font-sans">
      <header className="sticky top-0 z-50 bg-gradient-to-r from-white to-[#082846] shadow-lg flex justify-between items-center px-6 py-4">
        ...
        <button
          onClick={switchLang}
          className="bg-[#d7b940] text-[#082846] px-4 py-2 rounded font-bold"
        >
          {lang === "id" ? "ID" : "EN"}
        </button>
      </header>
      ...
      <section className="text-center py-20 px-8">
        ...
        <p className="max-w-4xl mx-auto leading-relaxed text-lg">
          {lang === "id"
            ? "Estetic Communication adalah perusahaan konsultan komunikasi yang berdiri sejak tahun 1997..."
            : "Estetic Communication is a communication consultancy company established in 1997..."}
        </p>
      </section>

      <section className="bg-white text-[#082846] px-8 py-16">
      ...
      <section className="bg-[#f9f9f9] text-[#082846] px-8 py-16">
