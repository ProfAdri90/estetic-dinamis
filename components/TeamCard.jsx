...
export default function TeamCard({ name, title, image }) {
  return (
    <div className="w-[145px] aspect-[3/4] relative group overflow-hidden rounded-lg shadow-md">
      <Image
        src={image}
        alt={name}
        fill
      ...
      />
      <div className="absolute bottom-0 left-0 w-full backdrop-blur-md bg-black/60 px-2 py-1 opacity-0 group-hover:opacity-100 translate-y-full group-hover:translate-y-0 transition-all duration-500 ease-in-out">
